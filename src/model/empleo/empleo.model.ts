...
export class EmpleoModel {
  ...
  public amount_employees:number;
  ...
  public sigiente_1:boolean = true;
  public sigiente_2:boolean = true;
  public sigiente_3:boolean = true;
  public sigiente_4:boolean = true;
